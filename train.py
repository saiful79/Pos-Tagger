...
UD_ENGLISH_TRAIN = os.path.join(ROOT_DIR,'en_partut-ud-train.conllu')
UD_ENGLISH_DEV = os.path.join(ROOT_DIR,'en_partut-ud-dev.conllu')
UD_ENGLISH_TEST = os.path.join(ROOT_DIR,'en_partut-ud-test.conllu')

def download_files():
    print('Downloading English treebank...')
    urllib.request.urlretrieve('http://archive.aueb.gr:8085/files/en_partut-ud-dev.conllu', ROOT_DIR+'/en_partut-ud-dev.conllu')
    urllib.request.urlretrieve('http://archive.aueb.gr:8085/files/en_partut-ud-test.conllu',ROOT_DIR+'/en_partut-ud-test.conllu')
    urllib.request.urlretrieve('http://archive.aueb.gr:8085/files/en_partut-ud-train.conllu', ROOT_DIR+'/en_partut-ud-train.conllu')
